...
public class DatabaseEndpoint {
    ...
    public Response showPersonsOfOneHobbies() {
    ...
    @Path("all")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAllPerformHobbies() {

        List<PerformsHobby> pf = em.createNamedQuery("PerformsHobby.findAll", PerformsHobby.class).getResultList();
        return Response.ok(pf.get(2).getPerson().getCity()).build();
    }
